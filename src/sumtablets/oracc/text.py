...
from sumtablets.oracc.cdl import CDLNode, Chunk, Discontinuity, DiscontinuityType, Lemma, parse_cdl_node
from sumtablets.oracc.enums import (
    Genre,
    Language,
    ObjectType,
    Period,
...
# ---------------------------------------------------------------------------
# CDL tree helpers (used by TextBase.transliteration)
# ---------------------------------------------------------------------------
